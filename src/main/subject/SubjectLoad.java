...
public class SubjectLoad extends Subject {
    ...
    private static void dataCareer3() {
        new Subject("Introducción a la Ingeniería", false,true,1,3);     // 104
        ...
        new Subject("Álgebra", false,true,2,3);                          // 109
        ...
        new Subject("Introducción a la Economía", false,true,3,3);       // 113
        ...
        new Subject("Estadística", false,true,4,3);                      // 117
        ...
        new Subject("Ciencia de los Materiales", false,true,5,3);        // 122
        ...
        new Subject("Mecanismos y Elementos de Máquinas", false,true,6,3);// 128
        ...
        new Subject("Calidad", false,true,7,3);                          // 133
        ...
        new Subject("Desarrollo de Productos", false,true,8,3);          // 138
        ...
        new Subject("Examen Nivel I de Portugués", false,true,9,3);      // 143
        new Subject("Legislación", false,true,9,3);
        new Subject("Coaching y Liderazgo", true,true,9,3);              // 145
        ...
        new Subject("Recursos Humanos", false,true,9,3);                 // 154
        ...
        new Subject("Dirección Industrial y Gerenciamiento", false,true,10,3); // 158
